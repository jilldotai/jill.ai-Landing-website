  ...
  return (
    <section className="py-32 px-6 md:px-20 bg-background relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="group relative overflow-hidden bg-foreground/5 backdrop-blur-xl rounded-[2.5rem] border border-foreground/10 p-8 md:p-20 transition-all duration-700 hover:border-accent/30 hover:shadow-[0_0_50px_-12px_rgba(212,141,93,0.2)]">
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="group/field relative">
                    <input
                      ...
                      className="w-full bg-transparent border-b border-foreground/10 py-3 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-accent transition-colors duration-500 font-light text-lg"
                    />
                ...
                <div className="group/field relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-transparent border-b border-foreground/10 py-3 text-foreground focus:outline-none focus:border-accent transition-colors duration-500 font-light text-lg appearance-none cursor-pointer"
                  >
                ...
                <div className="group/field relative">
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-transparent border-b border-foreground/10 py-3 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-accent transition-colors duration-500 font-light text-lg resize-none"
                  />
                  <div className="absolute bottom-0 left-0 w-0 h-[1px] bg-gradient-to-r from-cyan-400 to-purple-500 transition-all duration-700 group-focus-within/field:w-full" />
                </div>
                ...
                <div className="pt-6">
                  <button
                    type="submit"
                    className="group relative px-12 py-5 bg-foreground text-background rounded-full overflow-hidden transition-all duration-500 hover:shadow-[0_0_30px_rgba(0,0,0,0.2)] active:scale-95"
                  >
